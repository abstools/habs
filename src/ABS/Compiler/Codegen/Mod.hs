...
tModul (ABS.Module modulQTyp exports imports decls maybeMain) allSymbolTables = 
  HS.Module noLoc (HS.ModuleName mname)
    ...
    where
      ...
      tImport (ABS.StarFromImport _ityp qtyp) = [HS.ImportDecl noLoc (HS.ModuleName $ showQU qtyp) 
                                                 False -- qualified?
      ...
      tImport (ABS.AnyImport _ityp qas) = map (\ qa ->
                                            ...
                                            in HS.ImportDecl noLoc (HS.ModuleName prefix)
                                               True -- qualified?
                                               False False Nothing Nothing -- irrelevant
      ...
      tImport (ABS.AnyFromImport _ityp qas qu) = [HS.ImportDecl noLoc (HS.ModuleName $ showQU qu) 
                                                  False -- qualified?
                                                  False False Nothing Nothing -- irrelevant
