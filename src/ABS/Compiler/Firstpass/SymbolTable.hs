...
stdlibST = M.fromList $ map (\ (k,v) -> (SN k Nothing, SV v True))
  ...
  , ("SimDeploymentComponent", Class [TSimple $ U_ $ U ((0,0), "DeploymentComponent")] [TSimple $ U_ $ U ((0,0),"String"),TPoly (U_ $ U ((0,0),"Map")) [TSimple $ U_ $ U ((0,0),"Resourcetype"), TSimple $ U_ $ U ((0,0),"Rat")]])
